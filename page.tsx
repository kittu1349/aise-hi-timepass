...
import { useState } from 'react'
import { motion } from 'framer-motion'
import { Plus, Search, Calendar, Target, TrendingUp, Utensils } from 'lucide-react'
...
export default function NutritionPage() {
  ...
  const tabs = [
    { id: 'tracker', label: 'Food Tracker', icon: Utensils },
    { id: 'database', label: 'Food Database', icon: Search },
    { id: 'progress', label: 'Daily Progress', icon: TrendingUp },
  ]
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-600">Monitor your daily food intake and hit your calorie targets</p>
        </motion.div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.3 }}
        >
          {activeTab === 'tracker' && <NutritionTracker selectedDate={selectedDate} />}
          {activeTab === 'database' && <FoodDatabase />}
          {activeTab === 'progress' && <DailyProgress selectedDate={selectedDate} />}
        </motion.div>
      </div>
    </div>
  )
...
import { useState } from 'react'
import { motion } from 'framer-motion'
import { Plus, Calendar, Dumbbell, Zap, Clock, TrendingUp } from 'lucide-react'
